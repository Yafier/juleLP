        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-left mb-12">
            ...
            >
              ...
              <br />
              <span className="font-medium">We Got You Covered</span>
            </motion.h2>
